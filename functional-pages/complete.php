...
if (isset($_POST['submit'])) {
    $sql = "UPDATE bookings SET complete = '1' WHERE id = '$id'";
    $conn->query($sql);
    echo '<div style="text-align:center;padding:15px;"><p><i class="far fa-check-circle"></i>Thank you for having our service</p><a class="btn btn-success" href="customer_profile.php" role="button">Back to Dashboard</a></div>';
    die();
}
?>
...
<div class="container" style="margin-bottom: 80px;">
    <div class="feedback">
        ...
        <form method="post">
            ...
            <textarea cols="75" name="commentText" rows="5" style=""></textarea><br>
            <br>
            <div class="clear"></div>
